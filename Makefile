...
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-clang CONFIG+=debug -o Makefile FluidSim.pro
#############################################################################
...
DISTDIR = /home/i7611989/FluidSim/obj/FluidSim1.0.0
LINK          = clang++
...
Makefile: FluidSim.pro .qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-clang/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-clang CONFIG+=debug -o Makefile FluidSim.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/NGLScene.h include/Particle.h include/Emitter.h include/Cell.h include/Grid.h include/Fluid.h include/SHash.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/NGLScene.cpp src/Particle.cpp src/Emitter.cpp src/Cell.cpp src/Grid.cpp src/Fluid.cpp src/SHash.cpp $(DISTDIR)/
