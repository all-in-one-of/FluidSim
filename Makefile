...
# Template: app
# Command: /opt/qt/5.5/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug -o Makefile FluidSim.pro
#############################################################################
...
DISTDIR = /home/i7611989/SPH/FluidSim/obj/FluidSim1.0.0
LINK          = g++
LFLAGS        = -fopenmp -Wl,-rpath,/opt/qt/5.5/gcc_64 -Wl,-rpath,/opt/qt/5.5/gcc_64/lib
LIBS          = $(SUBLIBS) -L/usr/local/alembic-1.5.8/lib/static -lAbcWFObjConvert -lAlembicAbcCoreOgawa -lAlembicAbc -lAlembicAbcGeom -lAlembicAbcCollection -lAlembicAbcMaterial -lAlembicAbcCoreAbstract -lAlembicAbcOpenGL -lAlembicAbcCoreFactory -lAlembicOgawa -lAlembicAbcCoreHDF5 -lAlembicUtil -L/usr/local/lib -lHalf -L/home/i7611989/NGL/lib -l NGL -ltiff -L/opt/qt/5.5/gcc_64/lib -lQt5OpenGL -L/usr/lib64 -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
OBJECTS       = obj/main.o \
		...
		obj/Boundary.o \
		obj/RBD.o
DIST          = FluidSim.pro include/NGLScene.h \
		include/Particle.h \
		include/Emitter.h \
		include/Cell.h \
		include/Grid.h \
...
Makefile: FluidSim.pro .qmake.cache /opt/qt/5.5/gcc_64/mkspecs/linux-g++/qmake.conf /opt/qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=debug -o Makefile FluidSim.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/NGLScene.h include/Particle.h include/Emitter.h include/Cell.h include/Grid.h include/Fluid.h include/SHash.h include/Boundary.h include/RBD.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/NGLScene.cpp src/Particle.cpp src/Emitter.cpp src/Cell.cpp src/Grid.cpp src/Fluid.cpp src/SHash.cpp src/Boundary.cpp src/RBD.cpp $(DISTDIR)/
...
obj/SHash.o: src/SHash.cpp include/SHash.h \
		/home/i7611989/NGL/include/ngl/Vec3.h \
		/home/i7611989/NGL/include/ngl/Types.h \
		/home/i7611989/NGL/include/ngl/glew.h \
		/opt/qt/5.5/gcc_64/include/QtOpenGL/QGLContext \
		...
		/home/i7611989/NGL/include/ngl/VertexArrayObject.h \
		include/Particle.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/SHash.o src/SHash.cpp
...
obj/RBD.o: src/RBD.cpp include/RBD.h \
		/home/i7611989/NGL/include/ngl/Vec3.h \
		/home/i7611989/NGL/include/ngl/Types.h \
		/home/i7611989/NGL/include/ngl/glew.h \
		/opt/qt/5.5/gcc_64/include/QtOpenGL/QGLContext \
		...
		/home/i7611989/NGL/include/ngl/VertexArrayObject.h \
		include/Particle.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/RBD.o src/RBD.cpp
